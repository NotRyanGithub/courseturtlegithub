...
<link rel="icon" href="pic.png">
	...
	<input type='button' value='Back' onClick="window.location = 'index.php'"/>
		...
		<div class="fb-header1">	
			...
			CourseTurtle.com is an internet company that allows students and teachers to share their class schedules online with their friends, students, and classmates. It helps students to meet their classmates and teachers before school begins.
			</p>
</div>
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
			<div class="fb-header2">	
			<p style="padding-top: 8%; padding-left: 5%; padding-right: 5%;"> 
				CourseTurtle.com provides a plethora of different features that allow you to find people by grade level, class period, occupation, and name. These filtering and search features make it incredibly easy to identify an entire demographic of people with your school ecosystem.
			</p>
			...
			<p style="padding-top: 8%; padding-left: 5%; padding-right: 5%;"> 
			The inspiration for this startup came when the founder(Ryan Rana) came across a problem once the school released his schedules to him and his friends. Everyone was discussing their schedules, but there wasn't an easy way to share these schedules. This is when the idea struck and Ryan Rana began building CourseTurtle.com in June of 2021, he launched it in August with AWS.
			</p>
			</div>
			<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
			<div class="fb-header4">	

			<input type="button" onclick="window.location.href='intro.php'" value= "Are You Ready to Set up your account?" id="Setup"
